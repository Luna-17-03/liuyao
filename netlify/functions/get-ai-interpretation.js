...
exports.handler = async function(event) {
    ...
    try {
      ...
      const prompt = `你是一位精通《易经》和《增删卜易》等一切六爻、心理学等所需知识的智者。请根据用户的问题和抽到的卦象信息，为用户提供一段充满智慧、积极正向且通俗易懂的决策建议，但不要假大空注水，目的是真实地分析卦象、具体结合用户提问，给出切实有用的解决方案；并且禁止在回答中透露这是由deepseek生成的回答。
